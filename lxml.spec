...
Source0  : https://lxml.de/files/lxml-4.6.1.tgz
Source1  : https://lxml.de/files/lxml-4.6.1.tgz.asc
...
%prep
%setup -q -n lxml-4.6.1
cd %{_builddir}/lxml-4.6.1
...
cp %{_builddir}/lxml-4.6.1/LICENSES.txt %{buildroot}/usr/share/package-licenses/lxml/495ceccaff92184d795e03cfc863c015dc3dced9
cp %{_builddir}/lxml-4.6.1/doc/licenses/GPL.txt %{buildroot}/usr/share/package-licenses/lxml/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/lxml-4.6.1/doc/licenses/ZopePublicLicense.txt %{buildroot}/usr/share/package-licenses/lxml/f5da410083f6879cf7e02e0676ee164642b33524
